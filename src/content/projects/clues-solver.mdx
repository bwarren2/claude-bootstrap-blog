...
heroImage: "/claude-bootstrap-blog/images/clues-solver-demo.gif"
featured: true
readingOrder: 3
promptSnippets:
...
Here's the solver completing today's puzzle automatically — click a card, read the clue, deduce, repeat:

![Solver demo — completing the puzzle in 14 iterations](/claude-bootstrap-blog/images/clues-solver-demo.gif)
